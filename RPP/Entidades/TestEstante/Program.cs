...
namespace TestEstante
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                cadena = Convert.ToString(Leer.ReadLine());
            }
           ...
           est1.GetValorEstante(Estante.ETipoProducto.Galletita));
            ...
            est1 = est1 - Estante.ETipoProducto.Galletita;
            ...
            est2 -= Estante.ETipoProducto.Todos;
            Console.WriteLine("Contenido Estante2:\n{0}", Estante.MostrarEstante(est2));
            Console.ReadLine();
